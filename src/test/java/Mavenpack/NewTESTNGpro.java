...
public class NewTESTNGpro {
	...
	Assert.assertTrue(driver.findElement(By.xpath(" //a[text()='Account']")).isDisplayed()); 
		...
		System.out.println();// true
				Assert.assertTrue(driver.findElement(By.xpath("//*[@class='product-thumb']//a[text()='iPhone']")).isDisplayed()); 
		...
		WebElement Successstatus = driver.findElement(By.cssSelector("div[class=\"alert alert-success alert-dismissible\"]"));
		String SuccessstatusText =Successstatus.getText();
		Assert.assertEquals(SuccessstatusText, Successstatus.getText() );
